...
def main():
	...
	training_features = vectorizer.fit_transform(training_ratios)
	...
	classifier = svm.SVC(C=1.0, kernel='rbf',gamma=1.0)
	...
	test_features = vectorizer.transform(test_ratios)
